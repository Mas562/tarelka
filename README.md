...
Откройте [последний релиз](https://github.com/Mas562/tarelka/releases/latest) и скачайте `Tarelka-2.4.0-arm64.zip`. Распакуйте его и перенесите «Тарелка.app» в «Программы». В релизе также есть файл контрольных сумм `SHA256SUMS.txt`.
