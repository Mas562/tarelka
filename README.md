...
Откройте [последний релиз](https://github.com/Mas562/tarelka/releases/latest) и скачайте `Tarelka-2.3.3-arm64.zip`. Распакуйте архив и перенесите «Тарелка.app» в «Программы». В релизе также есть файл контрольных сумм `SHA256SUMS.txt`.
