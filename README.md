...
**macOS 14+ · SwiftUI · Русский интерфейс · Версия 2.4.1**
...
Откройте [последний релиз](https://github.com/Mas562/tarelka/releases/latest) и скачайте `Tarelka-2.4.1-arm64.zip`. Распакуйте его и перенесите «Тарелка.app» в «Программы». В релизе также есть файл контрольных сумм `SHA256SUMS.txt`.
...
В исходниках 2.4.1 пройдены **99 тестов в 18 наборах**. Набор проверок охватывает арифметику порций и БЖУ, напитки, импорт активности, недельные отчёты, обработку ответов моделей, сохранение диктовки после пауз, календарные переходы и баланс виджета. Тесты используют контролируемые данные и не заменяют проверку качества распознавания реальных блюд.
